...
class mainPage(tk.Frame):
    ...
    def main_page(self):
        ...
        fontStyle = tkFont.Font(family="TimeBurner", size = 13)
        ...
        self.sign_up = tk.Button(text="Sign Up", font=fontStyle, command=lambda: template.changePage(self, "sign up"))
        self.sign_up.place(x=625, y=300, width=140, height=50, anchor="c")

        self.forget = tk.Button(text="Forget Password", font=fontStyle, command=lambda: template.changePage(self, "forget password"))
        self.forget.place(x=625, y=400, width=140, height=50, anchor="c")
