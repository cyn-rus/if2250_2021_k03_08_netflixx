...
class forgetPassword2(tk.Frame):
    ...
    def forget_password2(self, code, idx):
        ...
        self.resend = tk.Button(text="Kirim Ulang", font=buttonFont, command=lambda: self.reSendEmail(idx))
        self.resend.place(x=400, y=400, width=120, height=43)

        self.submit = tk.Button(text="Submit", font=buttonFont, command=lambda: self.validateCode(idx, code))
    ...
    def validateCode(self, idx, code):
        ...
        if inputCode == str(code):
            ...
            self.wrongPin.place(x=480, y=450)
...
class forgetPassword3(tk.Frame):
    ...
    def forget_password3(self, idx):
        ...
        self.submit = tk.Button(text="Submit", font=buttonFont, command=lambda: self.changePassword(idx))
    ...
    def changePassword(self, idx):
        ...
        if pw == "" or confPw == "":
            tkMessageBox.showinfo("Dimohonkan duntuk")
            return
