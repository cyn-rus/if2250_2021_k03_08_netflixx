...
class addFilm(tk.Frame):
    ...
    def add_film_page(self):
        ...
        self.deskripsi1 = tk.Entry(font=entryFont)
        self.deskripsi1.place(x=270, y=515, width=840, height=27)
        ...
        self.film1.place(x=270, y=585, width=840, height=27)
