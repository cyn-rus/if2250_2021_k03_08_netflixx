...
class updateFilm(tk.Frame):
    ...
    def isIDFilmValid(self):
        ...
        self.submit.destroy()
        self.back = tk.Button(text="Ubah ID Film", font=buttonFont, bg="#010109", fg="#9f64d8", activebackground="#010109", activeforeground="#9f64d8", command=lambda: template.changePage(self, "update film"))
        ...
        # label
        self.id1.destroy()
        self.id1 = tk.Label(text=id, font=textFont, bg="#24225e", fg="#9f64d8")
        self.id1.place(x=270, y=95)

        self.judul = tk.Label(text="Judul Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.judul.place(x=270, y=140)
        self.judul1 = tk.Label(text=judulFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.judul1.place(x=270, y=165)

        self.poster = tk.Label(text="Nama File Poster Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.poster.place(x=270, y=210)
        self.poster1 = tk.Label(text=posterFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.poster1.place(x=270, y=235)

        self.tahun = tk.Label(text="Tahun Rilis Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.tahun.place(x=270, y=280)
        self.tahun1 = tk.Label(text=tahunFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.tahun1.place(x=270, y=305)

        self.umur = tk.Label(text="Batas Umur Penonton", font=textFont, bg="#24225e", fg="#9f64d8")
        self.umur.place(x=270, y=350)
        self.umur1 = tk.Label(text=umurFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.umur1.place(x=270, y=375)

        self.harga = tk.Label(text="Harga Tiket Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.harga.place(x=270, y=420)
        self.harga1 = tk.Label(text=hargaFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.harga1.place(x=270, y=445)

        self.deskripsi = tk.Label(text="Deskripsi Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.deskripsi.place(x=270, y=490)
        self.deskripsi1 = tk.Label(text=deskripsiFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.deskripsi1.place(x=270, y=515)

        self.film = tk.Label(text="Teks Isi Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.film.place(x=270, y=560)
        self.film1 = tk.Label(text=filmFilm[i], font=textFont, bg="#24225e", fg="#9f64d8")
        self.film1.place(x=270, y=585)

        # entry
        self.njudul = tk.Label(text="Judul Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.njudul.place(x=800, y=140)
        self.njudul1 = tk.Entry(font=entryFont)
        self.njudul1.place(x=800, y=165, width=210, height=27)

        self.nposter = tk.Label(text="Nama File Poster Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.nposter.place(x=800, y=210)
        self.nposter1 = tk.Entry(font=entryFont)
        self.nposter1.place(x=800, y=235, width=210, height=27)

        self.ntahun = tk.Label(text="Tahun Rilis Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.ntahun.place(x=800, y=280)
        self.ntahun1 = tk.Entry(font=entryFont)
        self.ntahun1.place(x=800, y=305, width=210, height=27)

        self.numur = tk.Label(text="Batas Umur Penonton", font=textFont, bg="#24225e", fg="#9f64d8")
        self.numur.place(x=800, y=350)
        self.numur1 = tk.Entry(font=entryFont)
        self.numur1.place(x=800, y=375, width=210, height=27)

        self.nharga = tk.Label(text="Harga Tiket Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.nharga.place(x=800, y=420)
        self.nharga1 = tk.Entry(font=entryFont)
        self.nharga1.place(x=800, y=445, width=210, height=27)

        self.ndeskripsi = tk.Label(text="Deskripsi Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.ndeskripsi.place(x=800, y=490)
        self.ndeskripsi1 = tk.Entry(font=entryFont)
        self.ndeskripsi1.place(x=800, y=515, width=540, height=27)

        self.nfilm = tk.Label(text="Teks Isi Film", font=textFont, bg="#24225e", fg="#9f64d8")
        self.nfilm.place(x=800, y=560)
        self.nfilm1 = tk.Entry(font=entryFont)
        self.nfilm1.place(x=800, y=585, width=540, height=27)
        ...
        self.submit.place(x=590, y=660, width=140, height=40)
