...
data=[
    ["a@gmail.com", "aaa", "ini a", "aAaA", "01/01/2001"],
    ["b@gmail.com", "bbb", "bukan b", "lalala", "02/02/2002"],
    ["c@gmail.com", "ccc", "saya c", "hemhemhem", "03/03/2003"]
    ]
...
def isSignUpValid(email, username, pw, conf_pw, name, dob):
    ...
    return [email, username, name, pw, alteredDOB]
...
def test():
    ...
    assert isSignInValid("a@gmail.com", "aAaA") == True
    assert isSignInValid("bbb", "lalala") == True
    ...
    assert isSignUpValid("d@gmail.com", "ddd", "LaLaLaLa3#", "LaLaLaLa3#", "waaa", "1/1/01") == ["d@gmail.com", "ddd", "waaa", "LaLaLaLa3#", "01/01/2001"]
